return {
  ...
  },
  {
    ...
    opts = {
      ...
      contrast = "hard", -- Set contrast level (options: "hard", "medium", "soft")
    },
  },
  {
  ...
  },
  {
    ...
    config = function()
      require("colorizer").setup({
        "*", -- Habilita el color para todos los archivos
        css = { rgb_fn = true }, -- Activa las funciones rgb() en CSS
        html = { names = false }, -- Deshabilita los nombres de colores en HTML
      }, { mode = "background" }) -- Usa el color como fondo del texto
    end,
  },
}
